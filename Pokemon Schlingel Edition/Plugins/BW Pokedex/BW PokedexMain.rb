...
# The following instructions are part of the original PScreen_PokedexMain. I've 
...
=end
  ...
  def pbRefresh
    ...
    textpos = [
       [dexname,18,2,0,Color.new(222,222,222),Color.new(132,132,132)]
    ]
  # Changes the position of the Species Name's, as well as the color of the text, 
  # to mimic the one used in BW    
