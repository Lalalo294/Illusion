module QuestModule
  ...
  Quest1 = {
    :ID => "1",
    :Name => "Du kannst nicht lost werden ",
    :QuestGiver => "DumbbrothersTV",
    :Stage1 => "Schau dir das feature an.",
    :Location1 => "Titan Town",
    :QuestDescription => "Sephi war wegen Pokemon Gaia manchmal lost, hier ist ein Questbuch",
    :RewardString => "Anti lost Pille!"
  }
