...
#===============================================================================
#  aliasing to return nuzlocked battlers
#===============================================================================
alias pbBattleOnStepTaken_nuzlocke_x pbBattleOnStepTaken unless defined?(pbBattleOnStepTaken_nuzlocke_x)
def pbBattleOnStepTaken(*args)
  $nuzx_static_enc  = true
  pbBattleOnStepTaken_nuzlocke_x(*args)
  $nuzx_static_enc  = false
end
#===============================================================================
